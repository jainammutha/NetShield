...
if __name__ == '__main__':
    name, label_name = recognition_liveness('face_recognition_and_liveness/face_liveness_detection/dataset/model.keras', 'face_recognition_and_liveness/face_liveness_detection/dataset/label_encoder.pickle', 
                                            'face_recognition_and_liveness/face_liveness_detection/face_detector', '../face_recognition/encoded_faces.pickle', confidence=0.5)
